...
class TestServiceRequestAPI:
    def test_create_request(self, api_client, management, tenant, property_obj):
        payload = json.dumps(
            {
    ...
    def test_list_requests(self, api_client, management):
    ...
    def test_list_requests_filter_by_status(self, api_client, management):
    ...
    def test_list_requests_filter_by_property(self, api_client, management, property_obj):
    ...
    def test_list_requests_paginated(self, api_client, management):
        for _ in range(5):
            ServiceRequestFactory()
        response = api_client.get(
    ...
    def test_retrieve_request(self, api_client, management):
    ...
    def test_retrieve_request_404(self, api_client, management):
        response = api_client.get(
    ...
    def test_partial_update_request(self, api_client, management):
    ...
    def test_assign_request(self, api_client, management):
    ...
    def test_assign_request_404(self, api_client, management):
    ...
    def test_resolve_request(self, api_client, management):
    ...
    def test_resolve_request_404(self, api_client, management):
    ...
    def test_invalid_create_request_data(self, api_client, management):
