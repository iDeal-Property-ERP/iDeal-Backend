...
|---|-----------------------------------------------------|------------------------------------|
| `LOCATION` | Project directory on the server                     | `/opt/projects/ideal-backend` |
...
| Secret Name | Description | Example                                    |
|---|---|--------------------------------------------|
| `CONTAINER_NAME` | Docker container name/image name | `ideal`                       |
...
| `LOCATION` | Project directory on the server | `/home/deploy/projects/ideal-backend` |
